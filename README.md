...
This repo includes 2 plugins:
- HDFilmCehennemi
- Selcukflix

1. Open the root build.gradle.kts, read the comments and replace all the placeholders
2. Familiarize yourself with the project structure. Most files are commented
3. Build or deploy plugins using:
   - Windows: `.\gradlew.bat HDFilmCehennemi:make` or `.\gradlew.bat Selcukflix:make`
   - Linux & Mac: `./gradlew HDFilmCehennemi:make` or `./gradlew Selcukflix:make`
